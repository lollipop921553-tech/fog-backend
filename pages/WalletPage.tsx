      ...
      <div>
        ...
        <div className="space-y-4">
            <PaymentMethod title="Easypaisa" description="Pakistan | 1-2 hours" icon={<EasypaisaIcon className="text-green-500" />}>
                 <form className="flex flex-col sm:flex-row sm:items-end gap-2">
                    <input type="tel" placeholder="Your Easypaisa Account Number" className="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-fog-white dark:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-fog-accent"/>
                    <button type="submit" className="w-full sm:w-auto px-4 py-2 bg-fog-accent text-white font-semibold rounded-lg shadow-sm hover:bg-fog-accent-hover transition-colors">Withdraw</button>
                </form>
            </PaymentMethod>
            <PaymentMethod title="Jazzcash" description="Pakistan | 1-2 hours" icon={<JazzcashIcon className="text-red-500" />}>
                 <form className="flex flex-col sm:flex-row sm:items-end gap-2">
                    <input type="tel" placeholder="Your Jazzcash Account Number" className="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-fog-white dark:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-fog-accent"/>
                    <button type="submit" className="w-full sm:w-auto px-4 py-2 bg-fog-accent text-white font-semibold rounded-lg shadow-sm hover:bg-fog-accent-hover transition-colors">Withdraw</button>
                </form>
            </PaymentMethod>
            <PaymentMethod title="Bank Transfer" description="International | 3-5 days" icon={<BankIcon />}>
                 <form className="flex flex-col sm:flex-row sm:items-end gap-2">
                    <input type="text" placeholder="Your IBAN" className="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-fog-white dark:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-fog-accent"/>
                    <button type="submit" className="w-full sm:w-auto px-4 py-2 bg-fog-accent text-white font-semibold rounded-lg shadow-sm hover:bg-fog-accent-hover transition-colors">Withdraw</button>
                </form>
            </PaymentMethod>
        </div>
