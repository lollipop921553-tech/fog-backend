    ...
    <div className="space-y-24 animate-fade-in">
      ...
      <section className="text-center py-20 bg-gradient-to-br from-fog-light to-blue-100 dark:from-fog-dark dark:to-slate-800 rounded-2xl">
        ...
        <div className="mt-8 flex justify-center flex-wrap gap-4">
          <Link to="/freelance" state={{ from: 'HomePageFindTalent' }} className="px-8 py-3 bg-fog-accent text-white font-semibold rounded-lg shadow-md hover:bg-fog-accent-hover transition-transform transform hover:scale-105">
            Find Talent
          </Link>
